...
type Business = { id: string; name: string; slug: string; description: string; phone: string; address: string; providers: Provider[] };
type Catalog = {
  business: Business;
...
export default function HomePage() {
  ...
  async function chooseBusiness(business: Business) {
    ...
    setMessage("");
    try {
      const data = await request<Catalog>(`/businesses/${business.slug}/booking_catalog/`);
      setCatalog(data);
